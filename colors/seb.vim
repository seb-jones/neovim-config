" Name:       seb.vim
" Version:    0.1.0
" Maintainer: github.com/seb-jones
" License:    The MIT License (MIT)
"
" A minimal colorscheme for Vim that only puts emphasis on meep.
"
" Fork of vim-paramount:
"
...
call s:h("Cursor",        {"bg": s:gold, "fg": s:norm })
call s:h("Comment",       {"fg": s:bg_subtle, "gui": "italic"})

call s:h("Constant",      {"fg": s:norm})

call s:h("Literal",       {"fg": s:gold})
...
call s:h("Todo",          {"fg": s:gold, "gui": "underline", "cterm": "underline"})
call s:h("SpecialKey",    {"fg": s:light_green})
call s:h("NonText",       {"fg": s:medium_gray})
call s:h("Directory",     {"fg": s:dark_blue})
call s:h("ErrorMsg",      {"fg": s:red})
call s:h("IncSearch",     {"bg": s:yellow, "fg": s:light_black})
call s:h("Search",        {"bg": s:gold, "fg": s:light_black})
call s:h("MoreMsg",       {"fg": s:medium_gray, "cterm": "bold", "gui": "bold"})
hi! link ModeMsg MoreMsg
call s:h("LineNr",        {"fg": s:bg_subtle})
call s:h("CursorLineNr",  {"fg": s:gold, "bg": s:bg_very_subtle})
...
call s:h("PmenuSel",      {"fg": s:norm, "bg": s:gold})
call s:h("PmenuSbar",     {"fg": s:norm, "bg": s:bg_subtle})
call s:h("PmenuThumb",    {"fg": s:norm, "bg": s:bg_subtle})
call s:h("TabLine",       {"fg": s:norm, "bg": s:bg_very_subtle})
call s:h("TabLineSel",    {"fg": s:gold, "bg": s:bg_subtle, "gui": "bold", "cterm": "bold"})
